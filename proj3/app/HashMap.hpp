...
private:
    ...
    // IMPORTANT!
    // An array of buckets containing heads of linked lists
    // implemented as double pointer.
    Node* *buckets; 
    
    unsigned int totalNodesCount; // track the number of nodes (key/pairs) in the buckets array
    unsigned int totalBucketsCount; // track the capacity of the buckets array
};
